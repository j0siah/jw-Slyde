	...
	$.fn.fullpage = function(options) {
		...
		*/
		...
		$('.fp-section').each(function(index){
			...
			if (numSlides > 1) {
                ...
                $(this).find('.fp-slides').after('<div class="fp-controlArrow fp-prev"><span class=" s-nav s-white ti-angle-left"></span></div><div class="fp-controlArrow fp-next"><span class="s-nav s-white ti-angle-right"></span></div>');

				if(options.controlArrowColor!='#fff'){
					$(this).find('.fp-controlArrow.fp-next').css('color', 'transparent transparent transparent '+options.controlArrowColor);
					$(this).find('.fp-controlArrow.fp-prev').css('color', 'transparent '+ options.controlArrowColor + ' transparent transparent');
				}
		...
		*/
		...
		function activateMenuElement(name){
			if(options.menu){
				$(options.menu).find('.s-menu-c').removeClass('s-menu-c');
				$(options.menu).find('[data-menuanchor="'+name+'"]').addClass('s-menu-c');
               // alert("changed to" + name);
			}
		}
